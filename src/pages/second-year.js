  ...
  return (
    <Layout>
      <main className="page-main">
        ...
        <p>Overall Year Grade: 2.1 (61.5%)</p>
        ...
        <section className="section-dark">
            <h2>Snowbelle University Java GUI</h2>
            <p>
            ...
            <div className="projectImgWrapper">
                ...
                <img className="projectImg" src="images/com2008screenshot2.jpg" alt="Image of log in screen."/>
            </div>
        </section>
